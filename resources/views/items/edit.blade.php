    ...
    <div class="flex">
        ...
        <div class="px-5 w-full bg-white">
            ...
            <form action="{{ route('items.update',$item->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("put")
                <div class="grid grid-cols-2 gap-5 my-5 mx-1">
                    {{-- Item Info --}}
                    <div class="">
                        <div class="mb-5">
                            ...
                            <select name="category"
                                ...
                                @forelse ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ $category->id == old('category',$item->category->id) ? 'selected' : '' }}>{{ $category->title }}
                                    </option>
                                @empty
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" value="{{ old('price',$item->price) }}" name="price" id="price"
                        ...
                        <div class="mb-5">
                            ...
                            <select name="condition"
                                ...
                                <option value="new" {{ old('condition',$item->item_condition) == 'new' ? 'selected' : '' }}>New</option>
                                <option value="used" {{ old('condition',$item->item_condition) == 'used' ? 'selected' : '' }}>Used</option>
                        ...
                        <div class="mb-5">
                            ...
                            <select name="type"
                                ...
                                <option value="sell" {{ old('type',$item->type) == 'sell' ? 'selected' : '' }}>Sell</option>
                                <option value="buy" {{ old('type',$item->type) == 'buy' ? 'selected' : '' }}>Buy</option>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="checkbox" name="status" class="form-checkbox rounded text-violet-600 me-1" {{ old('status',$item->status) ? "checked":"" }}><span
                    ...
                    <div class="">
                        <div class="mb-5">
                            ...
                            <input type="text" value="{{ old('owner_name',$item->owner->name) }}" name="owner_name" id="owner_name"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex">
                                <div
                                    ...
                                    +95</div>
                                <input type="text" value="{{ old('phone',$item->owner->phone) }}" placeholder="Enter Phone Number"
                                    name="phone"
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="address" rows="4" name="address"
                                ...
                                placeholder="Enter Address...">{{ old('address',$item->owner->address) }}</textarea>
                            @error('address')
                                <div class="text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
